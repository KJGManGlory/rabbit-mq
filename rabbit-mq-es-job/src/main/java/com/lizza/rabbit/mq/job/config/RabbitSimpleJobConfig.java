...
import com.lizza.rabbit.mq.job.listener.SimpleJobListener;
import com.lizza.rabbit.mq.job.task.RabbitSimpleJob;
...
@Configuration
public class RabbitSimpleJobConfig {
	 ...
	 * 具体真正的定时任务执行逻辑
	 * @param
	 * @return com.dangdang.ddframe.job.api.simple.SimpleJob
	 */
	@Bean
	public SimpleJob simpleJob() {
		return new RabbitSimpleJob();
	}
